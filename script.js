...
const quizArray = [
  ...
  },
  {
    ...
    correct: "It is a scripting language used to make the website interactive",
  },
  {
    id: "2",
    question: "What is the use of this JavaScript statement?  <button onclick=window.print()>Submit</button>",
    options: ["It will write Submit on the current Window","It will print the content of the current page","It will write the content of the current page in the browser’s console","None of the above"],
    correct: "It will print the content of the current page",
  },
  {
    id: "3",
    question: "The const keyword is used to define a ______.",
    options: ["Function scopes variable","Block scoped variable","Constant","Constant with no initial value"],
    correct: "Constant",
  },
];
